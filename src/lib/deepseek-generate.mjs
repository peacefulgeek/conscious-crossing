...
// deepseek-chat is the current DeepSeek V3/V4 model endpoint
...
- Do NOT use em-dashes (— or –). Use a hyphen with spaces ( - ) instead.
...
const ASIN_POOL = [
  ...
  { asin: '0062508350', name: 'The Tibetan Book of Living and Dying' },
...
Remember: 1,200-2,500 words. Direct address. Contractions. 2-3 dialogue markers. No em-dashes. No banned words or phrases.`;
